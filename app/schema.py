...
from .mutations import SetPlanetMutation,SetPeopleMutation,UpdatePeopleMutation
...
class Mutation(graphene.ObjectType):
    set_planet_mutation = SetPlanetMutation.Field()
    set_People_mutation = SetPeopleMutation.Field()
